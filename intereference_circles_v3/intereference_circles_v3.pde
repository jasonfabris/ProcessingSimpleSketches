...
beginRecord(PDF, String.format("C:/Users/Jason/Documents/Processing Projects/Output/interference_pattern3_%d%d%d%d%d.pdf", year(), month(), day(), hour(), minute(), second()));
...
color b = color(20, 100, 25);
color l = color(330, 90, 100);
